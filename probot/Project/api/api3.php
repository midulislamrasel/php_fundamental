...
$res_method = $_SERVER['REQUEST_METHOD'];
 ...
 }else if($content_type=="application/x-www-form-urlencoded" &&  $res_method=="POST"){
    $params=$_POST;    
 }else if(str_contains($content_type,"multipart/form-data") &&  $res_method=="POST"){
    $params=$_POST;
    $params["file"]=$_FILES["photo"];
 }else if($content_type!="application/json" && $res_method=="GET"){
     $params=$_GET;
 }
...
if(isset($_GET["class"])){
  ...
  if(class_exists($class)){
      ...
      $method=$_GET["method"];
      $res_method = $_SERVER['REQUEST_METHOD'];
      $http_content_type=isset($_SERVER["CONTENT_TYPE"])?$_SERVER["CONTENT_TYPE"]:"application/json";
      $params="";
