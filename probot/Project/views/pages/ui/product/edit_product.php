...
/*
	...
	if(!preg_match("/^[\s\S]+$/",$_POST["cmbProductSectionId"])){
...
*/
	if(count($errors)==0){
		...
		$product->product_section_id=$_POST["cmbProductSectionId"];
...
<?php
	...
	$html.=select_field(["label"=>"Product Section","name"=>"cmbProductSectionId","table"=>"product_sections","value"=>"$product->product_section_id"]);
