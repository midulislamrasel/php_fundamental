...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		if($action){
			$html.="<tr><th>Id</th><th>Name</th><th>Photo</th><th>Role Id</th><th>Email</th><th>Email Verified At</th><th>Password</th><th>Remember Token</th><th>Created At</th><th>Updated At</th><th>Action</th></tr>";
		}else{
			$html.="<tr><th>Id</th><th>Name</th><th>Photo</th><th>Role Id</th><th>Email</th><th>Email Verified At</th><th>Password</th><th>Remember Token</th><th>Created At</th><th>Updated At</th></tr>";
		}
		while($user=$result->fetch_object()){
			$action_buttons = "";
			if($action){
			...
			$html.="<tr><td>$user->id</td><td>$user->name</td><td><img src='img/$user->photo' width='100' /></td><td>$user->role_id</td><td>$user->email</td><td>$user->email_verified_at</td><td>$user->password</td><td>$user->remember_token</td><td>$user->created_at</td><td>$user->updated_at</td> $action_buttons</tr>";
		}
		$html.="</table>";
