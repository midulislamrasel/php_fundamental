...
class Product implements JsonSerializable{
	...
	public function set($id,$name,$offer_price,$manufacturer_id,$regular_price,$description,$photo,$product_category_id,$product_section_id,$is_featured,$star,$is_brand,$offer_discount,$uom_id,$weight,$barcode,$created_at,$updated_at){
		$this->id=$id;
		$this->name=$name;
	...
	public static function all(){
		global $db,$tx;
		$result=$db->query("select id,name,offer_price,manufacturer_id,regular_price,description,photo,product_category_id,product_section_id,is_featured,star,is_brand,offer_discount,uom_id,weight,barcode,created_at,updated_at from {$tx}products");
		$data=[];
	...
	public static function pagination($page=1,$perpage=10,$criteria=""){
		global $db,$tx;
		$top=($page-1)*$perpage;
		$result=$db->query("select id,name,offer_price,manufacturer_id,regular_price,description,photo,product_category_id,product_section_id,is_featured,star,is_brand,offer_discount,uom_id,weight,barcode,created_at,updated_at from {$tx}products $criteria limit $top,$perpage");
		$data=[];
		while($product=$result->fetch_object()){
			$data[]=$product;
		}
	...
	public static function find($id){
		global $db,$tx;
		$result =$db->query("select id,name,offer_price,manufacturer_id,regular_price,description,photo,product_category_id,product_section_id,is_featured,star,is_brand,offer_discount,uom_id,weight,barcode,created_at,updated_at from {$tx}products where id='$id'");
...
";
	...
	static function html_select_product_raw_materials($name="cmbProduct"){
		global $db,$tx;
		$html="<select id='$name' name='$name'> ";
	...
	static function html_select_product_finised_goods($name="cmbProduct",$id=1){
		global $db,$tx;
		$html="<select id='$name' name='$name'> ";
