...
<script>
	$(document).ready(function(){
        ...
        $('.edit_data').click(function(){
			uni_modal("Update Service Details","services/manage_service.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Service permanently?","delete_service",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("service Details","services/view_service.php?id="+$(this).attr('data-id'))
		})
